					...
					<div class="content">
						<div class="main-area">
							<div class="info">
								...
								<div class="picture">
									<div class="p1">
										<img src="${pageContext.request.contextPath}/images/orc-img/<s:property value="orchard.picture1"/>" />
										<span>果园图片</span>
									</div>
									<div class="p1">
										<img src="${pageContext.request.contextPath}/images/orc-img/<s:property value="orchard.picture2"/>" />
										<span>果园图片</span>
									</div>
									<div class="p1">
										<img src="${pageContext.request.contextPath}/images/orc-img/<s:property value="orchard.picture3"/>" />
										<span>果园图片</span>
									</div>
									<div class="p1">
										<img src="${pageContext.request.contextPath}/images/orc-img/<s:property value="orchard.picture4"/>" />
										<span>果园图片</span>
									</div>
									<div class="p1">
										<img src="${pageContext.request.contextPath}/images/orc-img/<s:property value="orchard.picture5"/>" />
										<span>果园图片</span>
									</div>
									<div class="p1">
										<img src="${pageContext.request.contextPath}/images/orc-img/<s:property value="orchard.picture6"/>" />
										<span>果园图片</span>
									</div>
									<div class="clear"></div>
								</div>
