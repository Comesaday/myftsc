...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改果树信息</strong></div>
  <s:if test="hasActionMessages()">
	<div class="panel-head" id="add"><s:actionmessage/></div>
  </s:if>
  <div class="body-content">
    <form method="post" class="form-x" action="${pageContext.request.contextPath }/tree/tree_mod.action" enctype="multipart/form-data">  
        <div class="form-group">
          ...
          <div class="field">
            ...
            <s:iterator value="catagories" var="cat">
              <option value="<s:property value="#cat.name"/>"><s:property value="#cat.name"/></option>
            </s:iterator>
            </select>
          </div>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="price" value="${tree.price}" data-validate="member:只能为数字"  />
          <div class="tips"></div>
        </div>
      </div>
	...
	<div class="clear"></div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="tpoint" value="${tree.tpoint }"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea name="detail" class="input" style="height:120px; border:1px solid #ddd;">${tree.detail }</textarea>
          <div class="tips"></div>
        </div>
      </div>
