...
<script type="text/javascript">
	function countDown(secs) {  
		...
		if (--secs >= 0) {
			...
			parent.window.location.href = "${pageContext.request.contextPath }/admin/login.jsp";
		}
	}
</script>
	...
	<br/>	<br/>	<br/>
		...
		<p align="center" style="font-size: 16px;">
			如果您的浏览器不支持跳转,<a style="text-decoration: none"
				href="&{pageContext.request.contextPath}/admin/login.jsp"><font color="#FF0000">请点击这里</font>
			</a>.
		</p>
	</div>
</body>
